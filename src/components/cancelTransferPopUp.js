...
export default function CancelTransferPopUp({ transfer, modifyShowPopUp, token})  {
    ...
    const handleCancelTransfer = async() => {
        try {
            ...
            const config = {
                method: "put",
                url: `/vehicle/transfer/cancel/${transfer._id}`,
                data: {password},
                headers: {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            ...
            }
            {
                (!showMsj && !loader) &&
                <div className="bg-white rounded-lg p-6 w-1/3 shadow-lg">
                    <h2 className="text-lg font-bold mb-4">Cancelar Transferencia</h2>
                    <p className="text-gray-700 mb-4">
                        ¡Estas a punto de cancelar la trasnferencia de tu vehículo: <strong>{transfer.vehicle.brand} {transfer.vehicle.model}</strong>, con el usuario {transfer.newOwner}!
                        <br/>
                        Una vez cancelada no puedes volver a activarla, tendras que enviar una nueva solicitud de transferencia.
                        <br/>
                        Si deseas continuar ingresa tu contraseña y haz clic en 'Cancelar trasnferencia'.
                    </p>
                    <div className="mb-4">
                    ...
                    <div className="flex justify-between">
                        <button className="bg-violet-700 text-white px-4 py-2 rounded hover:bg-violet-600" onClick={handleCancelTransfer}>
