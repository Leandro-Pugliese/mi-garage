...
export default function DeleteUserPopUp({ modifyShowPopUp, token})  {
            ...
            }
            {
                ...
                <div className="bg-white rounded-lg p-6 w-1/3 shadow-lg">
                    ...
                    <p className="text-gray-700 mb-4">
                        ¡Estas a punto de eliminar <strong>TU CUENTA</strong> de forma permanente!
                        <br/>
                        Una vez eliminada, tambien se eliminaran tus vehículos y las actividades de los mismos, sin posibilidad de recuperar la información.
                        <br/>
                        Si deseas continuar con la eliminación de tu cuenta, ingresa tu contraseña y haz clic en eliminar.
                    </p>
                    <div className="mb-4">
                    ...
                    <div className="flex justify-between">
                        <button className="bg-violet-700 text-white px-4 py-2 rounded hover:bg-violet-600" onClick={handleDeleteUser}>
                            Eliminar
                        </button>
