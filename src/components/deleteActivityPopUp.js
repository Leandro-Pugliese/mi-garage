...
export default function DeleteVehiclePopUp({ activityId, type, description, modifyShowPopUp, token})  {
            ...
            }
            {
                ...
                <div className="bg-white rounded-lg p-6 w-1/3 shadow-lg">
                    ...
                    <p className="text-gray-700 mb-4">
                        ¡Estas a punto de eliminar de forma permanente la actividad: <strong>{type} ({description})</strong>!
                        <br/>
                        Una vez eliminada, no podras recuperarla.
                        <br/>
                        Si deseas continuar ingresa tu contraseña y haz clic en eliminar.
                    </p>
                    <div className="mb-4">
                    ...
                    <div className="flex justify-between">
                        <button className="bg-violet-700 text-white px-4 py-2 rounded hover:bg-violet-600" onClick={handleDeleteActivity}>
                            Eliminar
                        </button>
